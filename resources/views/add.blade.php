...
<head>
   ...
   <link rel="stylesheet" href="{{url('/assets/css/admin_style/add.css')}}">
   ...
   <div class="add-container">
      <form action="" method="post">
         ...
         <div class="mb-3">
            ...
            <input type="text" class="form-control" name="singer" placeholder="name">
         </div>
         <div class="mb-3">
         ...
         <a href="{{route('admin.index')}}" class="btn btn-primary">Quay Lai</a>
         @csrf
      </form>
